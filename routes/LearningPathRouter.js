...
const {getLearningPathByCategories} = require("../public/javascripts/service/learnpath/GetLearningPathByCategory")
const {authorizeRole} = require("../public/javascripts/config/SecurityConfig");

/**
 * API yang digunakan untuk mendambahan Learning Path
...
router.get('/api/learn/categories/:id', authorizeRole("USER"),
    async function(req,
                   res){
