...
const {getLearningsUser, getAllLearningsForAdmin} = require("../public/javascripts/service/learning/GetLerningUser");
...
router.get('/api/admin/learning', authorizeRole("ADMIN"),
...
router.get('/api/admin/project/buy', authorizeRole("ADMIN"), async(req, res, next) => {
