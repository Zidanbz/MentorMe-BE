...
async function mappingResponse(req) {
  try {
    ...
    const isLearningCompleted =
      learning[0].progress === true || learning[0].progress === "true";
    ...
    const data = {
      ...
      picture: filePicture,
      // Add completion status fields for frontend
      isCompleted: isLearningCompleted,
      completed: isLearningCompleted,
      status: isLearningCompleted,
      learningId: learning[0].ID,
      train: [],
    };
